...
export default function BlogFeed() {
  ...
  // ✅ Log API Base URL to check if .env is loaded correctly
  ...
  useEffect(() => {
    ...
    setLoading(true);
    axios
      .get(`${import.meta.env.VITE_BACKEND_URL}${categoryEndpoint}`)
      .then((response) => {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_BACKEND_URL}/api/posts/latest`)
      .then((response) => {
